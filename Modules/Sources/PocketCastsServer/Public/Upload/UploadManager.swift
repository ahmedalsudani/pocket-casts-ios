...
public class UploadManager: NSObject {
    ...
    private lazy var wifiOnlyBackgroundSession: URLSession = {
        var config = URLSessionConfiguration.background(withIdentifier: "app.burrow.PCUploadBackgroundSession")
    ...
    private lazy var cellularBackgroundSession: URLSession = {
        var config = URLSessionConfiguration.background(withIdentifier: "app.burrow.PCUploadManualSession")
