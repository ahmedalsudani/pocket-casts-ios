...
struct UpNextCircularWidgetView: View {
    ...
    var widgetURL: String {
        return numberOfEpisodeInUpNext != 0 ? "burrow://upnext?source=lock_screen_widget" : "burrow://discover?source=widget"
    }
...
struct UpNextRectangularWidgetView: View {
    ...
    var widgetURL: String {
        return nextEpisode != nil ? "burrow://upnext?source=lock_screen_widget" : "burrow://discover?source=widget"
    }
